...
@section('title') {{$portfolio->seo->title}} @endsection
@section('description') {{$portfolio->seo->description}} @endsection
@section('keywords') {{$portfolio->seo->keywords}} @endsection
@section('canonical') {{$portfolio->seo->canonical}} @endsection
