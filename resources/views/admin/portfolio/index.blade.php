...
@section('header')
    ...
    <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <a class="dropdown-item" href="{{route('portfolio.create')}}">افزودن</a>
            <form action="{{route('multiRemovePor')}}" method="post">
                @csrf
...
@section('content')
    <div class="card">
        <h5 class="card-header">نمونه کار</h5>
        <div class="card-body">
            <table id="example1" style="width: 100%" class="table table-striped table-bordered">
                ...
                @foreach($items as $key=>$item)
                    <tr>
                        ...
                        <td>{{$key+1}}</td>
                        <td><a href="<?php echo json_decode($item->picture)->main?>"><img src="<?php echo json_decode($item->picture)->main?>" alt="{{$item->title}}" width="100" height="100"></a></td>
                        <td>{{$item->title}}</td>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                                    <a class="dropdown-item" href="{{route('portfolio.edit',$item->id)}}"><i class="fa fa-pencil ml-3"></i>ویرایش</a>
