...
@section('header')
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">دسته نمونه کار</li>
            </ol>
        </nav>
    </div>
    <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <a class="dropdown-item" href="{{route('category_portfolio.create')}}">افزودن</a>
            <form action="{{route('multiRemoveCatPor')}}" method="post">
                @csrf
...
@section('content')
    <div class="card">
        <h5 class="card-header">نمونه کارها</h5>
        <div class="card-body">
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                                    <a class="dropdown-item" href="{{route('category_portfolio.edit',$item->id)}}"><i class="fa fa-pencil ml-3"></i>ویرایش</a>
                                    @if($item->title != 'دسته بندی نشده')
                                    <form action="{{route('category_portfolio.destroy',$item->id)}}" method="post">
                                        @csrf
                                        @method('delete')
