...
@section('header')
    ...
    <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <a class="dropdown-item" href="{{route('menu.create')}}">افزودن</a>
            <form action="{{route('multiRemoveMenu')}}" method="post">
                @csrf
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                                    <a class="dropdown-item" href="{{route('menu.edit',$item->id)}}"><i class="fa fa-pencil ml-3"></i>ویرایش</a>
