...
@section('header')
    ...
    <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <a class="dropdown-item" href="{{route('slider.create')}}">افزودن</a>
        </div>
    </div>
@endsection
        ...
        <div class="card-body">
            <table id="example1" style="width: 100%" class="table table-striped table-bordered">
                ...
                @foreach($items as $key=>$item)
                    <tr>
                        <td>{{$key+1}}</td>
                        <td><a href="{{$item->picture}}" target="_blank"><img src="{{$item->picture}}" alt="{{$item->title}}" width="150" height="100"></a></td>
                        <td>{{$item->title}}</td>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                                    <a class="dropdown-item" href="{{route('slider.edit',$item->id)}}"><i class="fa fa-pencil ml-3"></i>ویرایش</a>
