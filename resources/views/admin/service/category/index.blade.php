...
@section('header')
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">دسته خدمات</li>
            </ol>
        </nav>
    </div>
    <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <a class="dropdown-item" href="{{route('category_service.create')}}">افزودن</a>
            <form action="{{route('multiRemoveCatSer')}}" method="post">
                @csrf
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                                    <a class="dropdown-item" href="{{route('category_service.edit',$item->id)}}"><i class="fa fa-pencil ml-3"></i>ویرایش</a>
                                    @if($item->title != 'دسته بندی نشده')
                                    <form action="{{route('category_service.destroy',$item->id)}}" method="post">
                                        @csrf
                                        @method('delete')
