        ...
        <div class="card-body">
            <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                    <a class="dropdown-item" style="cursor: pointer" href="/admin/admin/create">ثبت
                        اطلاعات</a>
...
{{--                    <th>حذف</th>--}}
                ...
                @if($isSuperAdmin)
                    <tr>
                        ...
                        <td><a href="{{route('admin.edit',['id'=>$super_admin->id])}}"><i
                    ...
                    <tr>
                        {{--<td class="idCheckbox">
                            <div class="custom-control custom-checkbox custom-checkbox-primary">
                                <input type="checkbox" class="custom-control-input" value="{{$admin->id}}"
                                       onclick="remove_all(this);" id="customCheck_{{$admin->id}}">
                                <label class="custom-control-label" for="customCheck_{{$admin->id}}"></label>
                            </div>
                        </td>--}}
