...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.update',$admin->id)}}" method="post" class="needs-validation" novalidate="" enctype="multipart/form-data"
                  autocomplete="off">
                @csrf
                @method('patch')
                <div class="mb-4">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-7 text-left">
                            <a href="{{$admin->picture}}" target="_blank">
                                <img src="{{$admin->picture}}" alt="{{$admin->title}}" width="150" height="100">
                            </a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-sm-7 text-left">
                            <a href="{{$admin->signature}}" target="_blank">
                                <img src="{{$admin->signature}}" alt="{{$admin->title}}" width="150" height="100">
                            </a>
                        </div>
                    </div>
                    <script>
                ...
                <div class="form-row form-group">
                    <div class="custom-control custom-checkbox custom-checkbox-success">
                        <input type="checkbox" class="custom-control-input" id="customCheck" name="accept_policy" @if($admin->accept_policy == 1) checked @endif>
