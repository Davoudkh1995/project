...
@section('header')
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">اخبار و مقالات</li>
            </ol>
        </nav>
    </div>
    <div class="btn-group" role="group">
        ...
        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
            <a class="dropdown-item" href="{{route('article.create')}}">افزودن</a>
            <form action="{{route('multiRemoveArt')}}" method="post">
                @csrf
...
@section('content')
    <div class="card">
        <h5 class="card-header">اخبار و مقالات</h5>
        <div class="card-body">
                ...
                @foreach($items as $key=>$item)
                    <tr>
                        ...
                        <td><a href="{{json_decode($item->picture)->main}}"><img
                                        src="{{json_decode($item->picture)->main}}" alt="{{$item->title}}" width="100"
                                        height="100"></a></td>
                        <td>{{$item->title}}</td>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop2">
                                    <a class="dropdown-item" href="{{route('article.edit',$item->id)}}"><i
